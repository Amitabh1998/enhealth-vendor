...
const index = () => {
  ...
  const saveHandler = async () => {
    try {
      console.log(category, subCategories, name, searchTerm);
    ...
    <div>
      ...
      {name !== null && (
        <MedicineAddDialog
          on={name ? true : false}
          setOn={setName}
          title={"Medicine details from inventory"}
        >
              ...
              <div className="w-full">
                ...
                <div className="flex justify-between w-full space-x-2 items-center">
                  <div>
                    ...
                    <div>{name?.packaging}</div>
                  </div>
                  <div>
                    <div className="text-gray-500">Units 1-2</div>
                    <div>
                      {name?.unit1}-{name?.unit2}
                    </div>
                  </div>
                  <div>
                    <div className="text-gray-500">Type</div>
                    <div>{name?.medicineType}</div>
                  </div>
                </div>
              </div>
            </div>
