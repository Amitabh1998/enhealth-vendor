...
function DiagnosticPayTable({ tableData = data, setTableData }) {
      ...
      <table className="w-full border-collapse border border-t-0 bg-white rounded-t-xl">
        <thead className="rounded-t-md">
          <tr className="bg-[#F8CD5B] bg-opacity-50 text-left rounded-t-md">
            ...
            <th className=" p-1 text-xs md:text-base md:p-2">Lab Center</th>
            ...
            <th className=" p-1 text-xs md:text-base md:p-2">Report</th>
...
export default DiagnosticPayTable;
