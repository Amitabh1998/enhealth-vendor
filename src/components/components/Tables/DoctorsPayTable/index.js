...
function DoctorsPayTable({ tableData = data, setTableData }) {
      ...
      <table className="w-full border-collapse border border-t-0 bg-white rounded-t-xl">
        <thead className="rounded-t-md">
          <tr className="bg-[#F8CD5B] bg-opacity-50 text-left rounded-t-md">
            ...
            <th className=" p-1 text-xs md:text-base md:p-2">Doctor's Name</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Payment Id</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Patient's NAme</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Date</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Fees</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Prescription</th>
            <th className=" p-1 text-xs md:text-base md:p-2">Invoice</th>
...
export default DoctorsPayTable;
