          ...
          <div className="w-full bg-white rounded-lg shadow-lg p-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              <div
                onClick={() =>
                  handleButtonClick(
                    data?.profile?.accreditationCertificate?.link
                  )
                }
                className="py-3 px-6 rounded-md bg-white shadow text-medium text-bluePrimary hover:bg-gray-100"
              >
                Accreditation Certificate - <span>View Document</span>
              </div>
              <div
                onClick={() =>
                  handleButtonClick(data?.profile?.letterOfAuthorisation?.link)
                }
                className="py-3 px-6 rounded-md bg-white shadow text-medium text-bluePrimary hover:bg-gray-100"
              >
                Letter Of Authorisation - <span>View Document</span>
              </div>
              <div
                onClick={() =>
                  handleButtonClick(
