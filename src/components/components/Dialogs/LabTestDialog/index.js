...
export default function LabtestDialog({ on, setOn }) {
  function closeModal() {
    setOn(false);
  }
      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex  min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full flex flex-col max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <div className="p-4 bg-white shadow-lg mt-5 flex items-center space-x-6 rounded-lg relative">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 max-w-md">
                      ...
                      effective immediate ssistance, emergency treatment or a
                      simple consultation.
                    </div>
                  </div>
                </div>
